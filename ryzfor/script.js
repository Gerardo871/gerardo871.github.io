...
var f = {
  ...
  , g = new (function() {
    ...
    return e.load = function(t, s, n) {
        if (t.el = typeof n == "string" ? document.querySelector(n) : n,
        t.options = c({}, f, s),
        ...
        t.isPaused = !1,
        t.strings = t.options.strings.map(function(p) {
            return p.trim()
        }),
        t.stringsElement = typeof t.options.stringsElement == "string" ? document.querySelector(t.options.stringsElement) : t.options.stringsElement,
        t.stringsElement) {
            t.strings = [],
  ...
  , l = new (function() {
    ...
    return e.typeHtmlChars = function(t, s, n) {
        if (n.contentType !== "html")
            return s;
        var o = t.substring(s).charAt(0);
        if (o === "<" || o === "&") {
            var r;
            for (r = o === "<" ? ">" : ";"; t.substring(s + 1).charAt(0) !== r && !(1 + ++s > t.length); )
                ;
            s++
        }
        return s
    ...
    e.backSpaceHtmlChars = function(t, s, n) {
        ...
        if (o === ">" || o === ";") {
            var r;
            for (r = o === ">" ? "<" : "&"; t.substring(s - 1).charAt(0) !== r && !(--s < 0); )
                ;
            s--
        }
        return s
  ...
  , m = function() {
    ...
    e.typewrite = function(t, s) {
        ...
        this.pause.status !== !0 ? this.timeout = setTimeout(function() {
            ...
            if (u.charAt(0) === "^" && /^\^\d+/.test(u)) {
                var p = 1;
                p += (u = /\d+/.exec(u)[0]).length,
                a = parseInt(u),
                n.temporaryPause = !0,
                n.options.onTypingPaused(n.arrayPos, n),
                t = t.substring(0, s) + t.substring(s + p),
                n.toggleBlinking(!0)
            }
            if (u.charAt(0) === "`") {
                ...
                !(s + r > t.length)); )
                    ;
                var h = t.substring(0, s)
                  , d = t.substring(h.length + 1, s + r)
                  , y = t.substring(s + r + 1);
                t = h + d + y,
                r--
            }
            n.timeout = setTimeout(function() {
                n.toggleBlinking(!1),
                s >= t.length ? n.doneTyping(t, s) : n.keepTyping(t, s, r),
    ...
    e.keepTyping = function(t, s, n) {
        s === 0 && (this.toggleBlinking(!1),
        this.options.preStringTyped(this.arrayPos, this));
        var o = t.substring(0, s += n);
        this.replaceText(o),
        this.typewrite(t, s)
    }
    ,
        ...
        if (this.pause.status !== !0) {
            ...
            this.timeout = setTimeout(function() {
                ...
                n.smartBackspace) {
                    ...
                    n.stopNum = a && r === a.substring(0, s) ? s : 0
                }
                s > n.stopNum ? (s--,
                n.backspace(t, s)) : s <= n.stopNum && (n.arrayPos++,
                n.arrayPos === n.strings.length ? (n.arrayPos = 0,
                n.options.onLastStringBackspaced(),
                n.shuffleStringsIfNeeded(),
                n.begin()) : n.typewrite(n.strings[n.sequence[n.arrayPos]], s))
            }, o)
        } else
...
new m(document.getElementById("typed"),{
    strings: ["SQL", "Python", "Apache Superset", "Apache Airflow", "Bash Script"],
    startDelay: 300,
    typeSpeed: 50,
    backSpeed: 50,
    backDelay: 2e3,
